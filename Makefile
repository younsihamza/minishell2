...
SRCS =  main.c tree.c transform_cmd.c tools.c lexeer.c transforn_help.c heredoc.c ft_strdup.c ft_split.c \
		ft_putstr.c  execute.c create_list.c ft_unset.c  handle_signal.c buildin.c execute_1.c execute_2.c
